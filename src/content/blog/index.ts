...
export const blogPosts: BlogPost[] = [
  ...
  // Artikel 85 & 86 - 2026-03-19
  {
    ...
    title: "Hybrid- und Elektro-Occasionen: Der wachsende Markt in der Schweiz 2026",
    excerpt: "E-Autos und Hybride als Occasion? Vor zwei Jahren noch ein Nischenmarkt. Heute eine Chance für Händler, die wissen, wie man Käuferbedenken adressiert und die richtigen Checks macht.",
    category: "Trends",
    readTime: 12,
    emoji: "⚡",
    ...
    keywords: ["Elektromobilität", "Hybrid", "Occasion", "Batterie", "Gebrauchtwagen"],
    content: `Ein Kunde ruft an: "Habt ihr auch Elektro-Occasionen?" Vor drei Jahren hätten Sie vermutlich "Nein, sorry" gesagt. Heute sagen Sie: "Ja, haben wir. Was suchen Sie genau?"
...
Der Markt ist da. Die Frage ist: Sind Sie bereit?`
  ...
  {
    slug: "verkaufsprozesse-automatisieren-kundengespraeche-zeit",
    title: "Digitale Verkaufsprozesse automatisieren: So gewinnen Sie Zeit für echte Kundengespräche",
    excerpt: "Automatisierung im Autohandel klingt nach Grosskonzern-Spielzeug. Ist es aber nicht. Kleine Händler können mit den richtigen Tools 10-15 Stunden pro Woche sparen – ohne Kunden zu verlieren.",
    ...
    publishedAt: "2026-03-19",
    author: "DealerOS Team",
    keywords: ["Automatisierung", "CRM", "Digitalisierung", "Verkaufsprozess", "Lead-Management"],
    content: `Ein normaler Dienstagmorgen: Sie kommen ins Büro, 14 neue Anfragen auf AutoScout24. Drei davon sind ernst gemeint, elf sind "Wie ist der letzte Preis?"-Nachrichten ohne echtes Interesse.
...
1. **Anfrage kommt rein** (AutoScout24, car.ch, Website, etc.)
2. **CRM erfasst automatisch:** Name, Fahrzeug, Plattform, Zeitpunkt
3. **Automatische Erstantwort:** "Danke, ich melde mich innerhalb von 24h"
4. **Lead wird kategorisiert:**
   - "Heiss" (konkrete Frage, Probefahrt-Wunsch)
   - "Warm" (allgemeines Interesse)
   - "Kalt" ("Wie ist der letzte Preis?")
5. **Follow-Ups automatisch geplant:**
...
1. Lead kommt auf AutoScout24 rein → automatisch in DealerOS erfasst
2. Automatische Antwort: "Danke für Ihr Interesse am VW Golf. Ich melde mich innerhalb von 24h."
3. DealerOS schlägt vor: "Lead ist heiss (Frage nach Probefahrt) → Termin vorschlagen"
4. Sie klicken "Termin vorschlagen" → DealerOS schickt Mail mit Terminoptionen
5. Kunde wählt Termin → automatisch in Kalender eingetragen
6. 24h vor Termin: automatische Erinnerung an Kunde
7. 1h vor Termin: automatische Erinnerung an Sie
...
1. **Tag 1:** Kunde schreibt, Sie antworten (oder automatische Erstantwort).
2. **Tag 3:** Kunde antwortet nicht → automatisches Follow-Up: "Haben Sie noch Fragen?"
3. **Tag 7:** Kunde antwortet immer noch nicht → automatisches Follow-Up: "Möchten Sie eine Probefahrt? Ich hätte diese Woche noch Termine frei."
4. **Tag 14:** Kunde antwortet immer noch nicht → automatisches Follow-Up: "Das Auto ist noch verfügbar. Falls Sie nicht mehr interessiert sind, kein Problem – dann nehme ich Sie aus dem Verteiler."
5. **Kunde antwortet:** Follow-Ups stoppen automatisch, Sie übernehmen manuell.
...
1. **Beim Fahrzeug-Upload:** Sie laden MFK-Bericht, Servicehistorie, Garantie-Bedingungen hoch (einmalig, 5 Minuten).
2. **Kunde fragt nach Dokumenten:** Sie klicken "Dokumente senden" → System schickt automatisch alle relevanten Dateien.
3. **Oder:** Kunde kann Dokumente direkt auf Ihrer Website herunterladen (ohne zu fragen).
...
1. **CRM eingeführt:** DealerOS (CHF 99/Monat)
2. **Automatische Erstantworten:** Alle Anfragen bekommen innerhalb von 5 Minuten eine Antwort
3. **Follow-Up-System:** 3 automatische Follow-Ups (Tag 3, 7, 14)
4. **Dokument-Workflow:** MFK-Berichte, Servicehistorien automatisch per Klick versenden
...
*Bei Fragen zur Umsetzung: Rechtsberatung einholen (dieser Artikel ersetzt keine Rechtsberatung).*`
  ...
  // Artikel 59 & 60 - 2026-03-06
  {
    ...
    title: "Eurotax verstehen: So nutzen Sie Bewertungen richtig",
    excerpt: "AutoScout24 sagt CHF 22'000, Eurotax sagt CHF 19'500 – was stimmt jetzt? Eurotax ist das Mass aller Dinge, aber auch eines der am meisten missverstandenen Tools. So nutzen Sie es richtig.",
    category: "Finanzen",
    readTime: 12,
    emoji: "💰",
    image: "https://images.unsplash.com/photo-1554224311-5b3caa5b6bf1?w=800&q=80",
    publishedAt: "2026-03-06",
    author: "Dealer OS Team",
    keywords: ["eurotax bewertung", "auto wert ermitteln", "fahrzeugbewertung", "gebrauchtwagen preis", "händler einkaufspreis"],
    content: `Letzte Woche stand ein Kunde bei mir und zeigte mir sein Smartphone: "AutoScout24 sagt CHF 22'000, Eurotax sagt CHF 19'500 – was stimmt denn jetzt?" Die Frustration war spürbar. Und ehrlich gesagt: Ich verstehe das.
...
**Beispiel:**
28. Februar: VW Tiguan, HEP CHF 28'000  
1. März: VW Tiguan, HEP CHF 27'200 (Wertverlust durch Alter)
...
**Jetzt 14 Tage gratis testen:** www.dealer-os.ch`
  ...
  {
    slug: "social-media-autohaendler-funktioniert",
    title: "Social Media für Autohändler: Was wirklich funktioniert",
    excerpt: "90% aller Autohändler machen Social Media falsch. Sie posten zufällig, inkonsistent, und erreichen niemanden. Nach 18 Monaten Begleitung von 50 Schweizer Garagen: Was funktioniert – und was Zeitverschwendung ist.",
    category: "Marketing",
    readTime: 12,
    emoji: "📱",
    ...
    publishedAt: "2026-03-06",
    author: "Dealer OS Team",
    keywords: ["instagram autohandel", "facebook auto verkaufen", "social media händler", "online marketing garage", "auto social media"],
    content: `"Laura, soll ich auf TikTok?" Diese Frage bekomme ich mittlerweile wöchentlich. Autohändler wissen, dass sie "irgendwas mit Social Media" machen sollten. Aber was genau? Und lohnt sich der Aufwand überhaupt?
...
**Wollen Sie Ihre Social-Media-Performance tracken?**  
Mit DealerOS sehen Sie, welche Kanäle Leads bringen, welche Fahrzeuge am meisten Interesse erzeugen, und wo Sie optimieren sollten. Alle Daten an einem Ort.
