...
export const artikel102: BlogPost = {
  slug: "mitarbeiterfuehrung-kleiner-autohandel-team-aufbauen",
  title: "Mitarbeiterführung im kleinen Autohandel: Vom Einzelkämpfer zum Team",
  excerpt: "Du verkaufst 10 Autos im Monat alleine. Jetzt willst du wachsen. Aber wie führst du Mitarbeiter, wenn du selbst noch alle Autos putzt und jede Probefahrt begleitest? Ein Leitfaden für den Übergang.",
  category: "Management",
  readTime: 13,
  emoji: "👥",
...
| Aufgabe | Chef (du) | Verkäufer | Aufbereiter |
|---------|-----------|-----------|-------------|
| Fahrzeuge suchen | ✅ | | |
| Besichtigen | ✅ | | |
| Reinigung | | | ✅ |
...
| Anfragen | | ✅ | |
| Probefahrten | | ✅ | |
| Preisverhandlung | ✅ | Unterstützung | |
| Kaufvertrag | ✅ | Unterstützung | |
| Buchhaltung | ✅ | | |
